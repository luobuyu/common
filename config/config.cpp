...
void Config::getValue(const std::string &section, const std::string &key, std::string &val, const std::string &default_value)
{
    if(!exist(section, key)) {
        val = default_value;
        return;
...
void Config::getValue(const std::string &section, const std::string &key, int &val, const int &default_value) {
    if (!exist(section, key))
    {
        val = default_value;
        return;
...
void Config::getValue(const std::string &section, const std::string &key, double &val, const double &default_value) {
    if (!exist(section, key))
    {
        val = default_value;
        return;
...
double Config::getDouble(const std::string &section, const std::string &key, const double &default_value) {
    double value;
    getValue(section, key, value, default_value);
    return value;
}
