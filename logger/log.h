...
#define LOG_OFF(str, ...) \
    ...
    public:
        ...
        void push_back_sink(const logger::LogSink::LogSinkPtr &log_sink);
        ...
        std::vector<std::shared_ptr<logger::LogSink>> get_log_sinks();
        void register_coredump_handler();
