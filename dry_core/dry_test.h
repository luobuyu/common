...
class Register {
 public:
  Register(const std::string& suite, const std::string& name, std::function<void()> func) {
...
#define DRY_TEST(suite, name)                                                                     \
  ...
  static ::dry::Register dry_test_reg_##suite##_##name(#suite, #name, dry_test_##suite##_##name); \
  static void dry_test_##suite##_##name()
